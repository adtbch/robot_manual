...
// =====================================================================
//  HYBRID INCLUDE: Arduino framework + Native ESP-IDF
//  - Arduino  : untuk PS4Controller library & Serial
//  - ESP-IDF  : untuk GPIO, UART, FreeRTOS, ESP-NOW, logging
// =====================================================================
...
// Format: "xx:xx:xx:xx:xx:xx" (huruf kecil, dipisah titik dua)58:BF:25:8B:DB:1A
static const char kPs4BluetoothMac[] = "58:bf:25:8b:db:1a"; // PS4 DualShock 4
